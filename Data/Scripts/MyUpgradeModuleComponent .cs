...
/*
namespace Upgrademodule
{

    public class MyUpgradeDefinition
    {
        public string UpgradeType { get; set; }
        public float UpgradePower { get; set; }

        public MyUpgradeDefinition() { }

        public MyUpgradeDefinition(string upgradeType, float upgradePower)
        {
            UpgradeType = upgradeType;
            UpgradePower = upgradePower;
        }

        public void Init(string upgradeType, float upgradePower)
        {
            UpgradeType = upgradeType;
            UpgradePower = upgradePower;
        }
